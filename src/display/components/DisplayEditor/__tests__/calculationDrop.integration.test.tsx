...
function Harness({ type = 'value', withExistingTrend = false }: { type?: 'value' | 'trend'; withExistingTrend?: boolean }) {
...
describe('DisplayEditor - drop de cálculo', () => {
  ...
  it('adiciona cálculo a uma Trend que já possui uma PI Point', () => {
    ...
    expect(document.elements[0].properties.series[1]).toMatchObject({ calculationId: 'calculation-1', legendLabel: 'Teste' });
  });
});
